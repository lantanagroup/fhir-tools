...
var Auth = (function () {
    ...
    Auth.prototype.authenticateRequest = function (reqOptions) {
        if (this.authHeader) {
    ...
    Auth.prototype.getClientCredential = function (tokenUrl, clientId, secret, resource) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                ...
                return [2, new Promise(function (resolve, reject) {
                        request(tokenUrl, options, function (err, res, body) {
                            if (err) {
                                reject(err);
                            }
                            else {
