...
var bundle_command_1 = require("./bundle-command");
yargs
    ...
    .command(bundle_command_1.BundleCommand.command, bundle_command_1.BundleCommand.description, bundle_command_1.BundleCommand.args, bundle_command_1.BundleCommand.handler)
    .help()
    .showHelpOnFail(true)
    .demandCommand()
    .argv;
